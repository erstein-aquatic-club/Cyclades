(function(){
  ...
  d.operational.days.j8=[
    ...
    {id:"j8-atv-rental",level:"attention",title:"Loukis · 450L confirmé",text:"Le modèle réservé est un ATV 450L, adapté à deux personnes et à la boucle prévue sur Paros.",action:"Permis physique à emporter. Confirmer le niveau de carburant attendu au retour et le numéro d’assistance. Garder le contrat sur soi."},
    {id:"j8-atv-safety",level:"attention",title:"Conduite du quad",text:"Rester sur les routes autorisées par le contrat de location. Casque conducteur et passager. Adapter la vitesse aux routes étroites, au vent et aux virages ; l’intérêt du 450L est surtout le couple et le confort à deux.",action:"Prévoir lunettes de soleil, eau, crème solaire et coupe-vent léger. Éviter plages, pistes et hors-piste si le contrat les exclut."},
